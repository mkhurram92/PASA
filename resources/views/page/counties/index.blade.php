        ...
        <div class="container-fluid main-container">
            <div class="page-header">
                <div class="page-leftheader">
                    <h3 class="page-title">Counties / States</h3>
                </div>
...
@section('scripts')
    <script>
        ...
        $('#create-record').click(function() {
            $.get("{{ route('counties.create') }}", form => {
                $('#crud').html(form.html);
                initCountriesSelect();
        ...
        document.getElementById('counties-table').addEventListener("click", function(e) {
        ...
        function openUpdateModal(cityId) {
            $.get("{{ route('counties.edit', ['county' => '__cityId__']) }}".replace('__cityId__', cityId), function(
                response) {
        ...
        function openViewModal(cityId) {
            $.get("{{ route('counties.show', ['county' => '__city__']) }}".replace('__city__', cityId), function(response) {
                $('#crud').html(response.html);
                $('#crud').find(".modal").modal('show');
            });
        }
