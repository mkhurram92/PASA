                ...
                <div class="col-md-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-header  justify-content-between">
                            <h3 class="card-title">Counties Table</h3>
                            @can("counties-create")
                                <div class="text-right">
                                    <a class="modal-effect btn btn-primary btn-block" href="javascript:void(0)" id="create-record" data-bs-effect="effect-slide-in-right">Create County</a>
                                </div>
                            @endcan
                        </div>
...
@section('scripts')
<script>
    var dt_ports_elem = $("#counties-table")
        , dt_ship = "";
    window.addEventListener("DOMContentLoaded", function() {
        ...
        const initDataTable = () => {
            if ($.fn.DataTable.isDataTable($('#counties-table'))) {
                $('#counties-table').DataTable().destroy();
            }
            // user datatable
