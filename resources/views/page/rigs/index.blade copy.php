                ...
                <div class="col-md-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-header  justify-content-between">
                            <h3 class="card-title">Rigs Table</h3>
                            @can("rigs-create")
                                <div class="text-right">
                                    <a class="modal-effect btn btn-primary btn-block" href="javascript:void(0)"
                                        id="create-record" data-bs-effect="effect-slide-in-right">Create Rig</a>
                                </div>
                            @endcan
                        </div>
...
@section('scripts')
    <script>
        ...
        window.addEventListener("DOMContentLoaded", function() {
            ...
            const initDataTable = () => {
                if ($.fn.DataTable.isDataTable($('#rigs-table'))) {
                    $('#rigs-table').DataTable().destroy();
                }
                // user datatable
