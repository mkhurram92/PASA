                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" class="form-control"
                                                                placeholder="Suburb" value="{{ $member?->suburb }}"
                                                                name="suburb">
                                                        </div>
                                                    </div>
                                                    <div class="mb-3 row">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="mb-3 row">
                                                        <label class="col-md-3 form-label">Email Address<span
                                                                class="tx-danger"> *</span></label>
                                                        <div class="col-md-9">
                                                            <input class="form-control" type="text"
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input id="key_holder" type="checkbox"
                                                                class="checkbox-input" name="key_holder"
                                                                value='1'
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="mb-3 mb-sm-0 d-flex align-items-center">
                                                                ...
                                                                <input id="emailed" type="radio"
                                                                    class="radio-input" name="journal" value="0"
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="mb-3 mb-sm-0 d-flex align-items-center">
                                                                ...
                                                                <input id="posted" type="radio"
                                                                    class="radio-input" name="journal" value="1"
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input id="registration_form_received" type="checkbox"
                                                                ...
                                                                name="registration_form_received" value='1'
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input id="signed_agreement" type="checkbox"
                                                                class="checkbox-input" name="signed_agreement"
                                                                value='1'
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input id="volunteer" type="checkbox"
                                                                class="checkbox-input" name="volunteer"
                                                                value='1'
