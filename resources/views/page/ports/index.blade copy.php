                        ...
                        <div class="card-header  justify-content-between">
                            ...
                            @can("ports-create")
                                <div class="text-right">
                                    <a class="modal-effect btn btn-primary btn-block" href="javascript:void(0)" id="create-record" data-bs-effect="effect-slide-in-right">Add a Port</a>
                                </div>
                            @endcan
                        </div>
...
<script>
    ...
    window.addEventListener("DOMContentLoaded", function() {
        ...
        const initDataTable = () => {
            if ($.fn.DataTable.isDataTable($('#ports-table'))) {
                $('#ports-table').DataTable().destroy();
            }
            // user datatable
