                     ...
                     <div class="card">
                         <div class="card-body p-2">
                             ...
                             <div class="table-responsive">
                                 <div id="membership-status-table"></div>
                             </div>
                         </div>
                     </div>
                 </div>
 ...
 @section('scripts')
     <script>
         ...
         $('#create-record').click(function() {
             $.get("{{ route('membership-status.create') }}", form => {
                 $('#crud').html(form.html);
         ...
         document.getElementById('membership-status-table').addEventListener("click", function(e) {
