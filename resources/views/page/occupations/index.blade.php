         ...
         <div class="container-fluid main-container">
             <div class="page-header">
                 <div class="page-leftheader">
                     <h3 class="page-title">Occupation List</h3>
                 </div>
                 <div class="card-header d-flex justify-content-between align-items-center">
                     <a class="btn btn-primary" href="javascript:void(0)" id="create-occuption-record">
 ...
 @section('scripts')
     <script>
         ...
         var table = new Tabulator("#occupations-table", {
             data: myData,
             layout: "fitColumns",
             columns: [{
                     title: 'ID',
         ...
         $('#create-occuption-record').click(function() {
             $.get("{{ route('occupations.create') }}", form => {
                 $('#crud').html(form.html);
         ...
         document.getElementById('occupations-table').addEventListener("click", function(e) {
         ...
         function openUpdateModal(cityId) {
             $.get("{{ route('occupations.edit', ['occupation' => '__cityId__']) }}".replace('__cityId__', cityId), function(response) {
         ...
         function openViewModal(cityId) {
             $.get("{{ route('occupations.show', ['occupation' => '__city__']) }}".replace('__city__', cityId), function(response) {
                 $('#crud').html(response.html);
