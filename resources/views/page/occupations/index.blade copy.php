                ...
                <div class="col-md-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-header  justify-content-between">
                            <h3 class="card-title">Occupations Table</h3>
                            @can('occupations-create')
                                <div class="text-right">
                                    <a class="modal-effect btn btn-primary btn-block" href="javascript:void(0)"
                                        id="create-record" data-bs-effect="effect-slide-in-right">Create Occupation</a>
                                </div>
                            @endcan
                        </div>
...
@section('scripts')
    <script>
        var dt_ports_elem = $("#occupations-table"),
            dt_ship = "";
        window.addEventListener("DOMContentLoaded", function() {
            ...
            const initDataTable = () => {
                if ($.fn.DataTable.isDataTable($('#occupations-table'))) {
                    $('#occupations-table').DataTable().destroy();
                }
                // user datatable
                if (typeof dt_ship !== "undefined") {
                    dt_ship = dt_ports_elem.DataTable({
                        processing: true,
                        serverSide: true,
                        ajax: {
