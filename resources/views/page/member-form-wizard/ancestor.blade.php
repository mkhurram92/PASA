...
<section>
    <div class="row">
        ...
        <div class="col-md-4 my-2">
            <label class="form-control-label">Place of Arrival in SA: <span class="tx-danger">*</span></label>
        ...
        <div class="col-md-4 my-2">
            <label class="form-control-label">Name of the Ship: <span class="tx-danger">*</span></label>
        ...
        <div class="col-md-4 my-2">
            ...
            <input class="form-control" id="partner_name" name="partner_name" value="{{ old('partner_name') }}"
                placeholder="Enter Full name" required="" type="text">
        </div>
        <div class="col-md-4 my-2">
