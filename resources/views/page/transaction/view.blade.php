                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-8">
                                                <input class="form-control" type="text" value="{{ optional($transaction->glCode)->name ?? 'No Sub G/L' }}" disabled readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-8">
                                                <input class="form-control" type="text" value="{{ optional($transaction->account)->name ?? 'No Transaction Account' }}" disabled readonly>
