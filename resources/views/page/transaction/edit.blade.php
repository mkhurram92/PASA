        ...
        <div class="container-fluid main-container">
            ...
            <div class="row">
                <div class="col-md-12 col-lg-12">
                    <div class="card">
                        <form class="form-horizontal" id="transaction_save_form"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="mb-3 row" id="supplier-container"
                                                @if ($transaction->transaction_type_id != 2) style="display: none;" @endif>
                                                    ...
                                                    <select name="supplier_id" id="supplier_id"
                                                        ...
                                                        @foreach ($suppliers as $supplier)
                                                            <option value="{{ $supplier->id }}"
                                                                @if ($transaction->supplier_id == $supplier->id) selected @endif>
                                                                {{ $supplier->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="mb-3 row" id="paying-for-member-container"
                                                @if ($transaction->transaction_type_id != 1) style="display: none;" @endif>
                                                <label class="col-md-4 form-label">Paid By Member<span
                                                        class="text-danger"></span></label>
                                                <div class="col-md-8">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            name="paying_for_member" id="paying_for_member_yes"
                                                            value="yes"
                                                            @if ($transaction->member_id) checked @endif>
                                                        <label class="form-check-label"
                                                            for="paying_for_member_yes">Yes</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            name="paying_for_member" id="paying_for_member_no"
                                                            value="no"
                                                            @if ($transaction->customer_id) checked @endif>
                                                        <label class="form-check-label"
                                                            for="paying_for_member_no">No</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="mb-3 row" id="customer-list-container"
                                                @if (!$transaction->customer_id) style="display: none;" @endif>
                                                    ...
                                                    <select name="customer_id" id="customer_id"
                                                        ...
                                                        @foreach ($customers as $customer)
                                                            <option value="{{ $customer->id }}"
                                                                @if ($transaction->customer_id == $customer->id) selected @endif>
                                                                {{ $customer->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="mb-3 row" id="membership-number-container"
                                                @if (!$transaction->member_id) style="display: none;" @endif>
                                                <label class="col-md-4 form-label">Membership Number<span
                                                        class="text-danger"></span></label>
                                                <div class="col-md-8 custom-select-wrapper">
                                                    <select name="membership_number" id="membership_number"
                                                        class="custom-select form-control">
                                                        <option value=""></option>
                                                    ...
                                                    <select name="parent_id" id="parent_id"
                                                        ...
                                                        @foreach ($parentGlCodes as $parentGlCode)
                                                            <option value="{{ $parentGlCode->id }}"
                                                                @if ($transaction->gl_code_id == $parentGlCode->id) selected @endif>
                                                                {{ $parentGlCode->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
