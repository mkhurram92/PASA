                            ...
                            <div class="col-xl-9 col-md-12 col-lg-12">
                                <div class="row">
                                    <div class="col-xl-4 col-lg-4 col-md-12">
                                        <div class="card">
                                            <div class="card-body">
                                                <svg class="card-custom-icon text-success icon-dropshadow-success"
                                                    x="1008" y="1248" viewBox="0 0 24 24" height="100%" width="100%"
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-12">
                                        <div class="card">
                                            <div class="card-body">
                                                <svg class="card-custom-icon text-secondary icon-dropshadow-secondary"
                                                    x="1008" y="1248" viewBox="0 0 24 24" height="100%" width="100%"
                                                    preserveAspectRatio="xMidYMid meet" focusable="false">
                                                    <path opacity=".0"
                                                ...
                                                <span class="mb-1 text-muted"><span class="text-success"><i
                                                            class="fa fa-caret-up  me-1"></i> 19.8</span> than last
                                                    month</span>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-12">
                                        <div class="card">
                                            <div class="card-body">
                                                <svg class="card-custom-icon text-primary icon-dropshadow-primary"
                                                    x="1008" y="1248" viewBox="0 0 24 24" height="100%" width="100%"
                                                    preserveAspectRatio="xMidYMid meet" focusable="false">
                                                    <path
                                                ...
                                                <span class="mb-1 text-muted"><span class="text-success"><i
                                                            class="fa fa-caret-up  me-1"></i> 0.8%</span> than last
                                                    month</span>
                                                ...
                                                <div class="col-xl-4 col-md-12 col-lg-5 pt-3 country-profit">
                                                    ...
                                                    <div class="countryscroll">
                                                        <table class="table countrytable">
                                                            <tbody>
                                                                <tr>
                                                                    <td class="w-1 text-center ps-5"><i
                                                                            class="flag flag-us "></i></td>
                                                                    <td>USA </td>
                                                                    <td class="text-end"><span
                                                                            class="font-weight-bold">$519.75</span></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="ps-5"><i class="flag flag-cn "></i></td>
                                                                    <td>China </td>
                                                                    <td class="text-end"><span
                                                                            class="font-weight-bold">$248.07</span></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="ps-5"><i class="flag flag-de "></i></td>
                                                                    <td>Germany </td>
                                                                    <td class="text-end"><span
                                                                            class="font-weight-bold">$190.57</span></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="ps-5"><i class="flag flag-ru "></i></td>
                                                                    <td>Russia </td>
                                                                    <td class="text-end"><span
                                                                            class="font-weight-bold">$173.25</span></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="ps-5"><i class="flag flag-in "></i></td>
                                                                    <td>India </td>
                                                                    <td class="text-end"><span
                                                                            class="font-weight-bold">$63.00</span></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="ps-5"><i class="flag flag-cn"></i></td>
                                                                    <td>China</td>
                                                                    <td class="text-end"><span
                                                                            class="font-weight-bold">$13.00</span></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="ps-5"><i class="flag flag-pk"></i></td>
                                                                    <td>Pakisthan</td>
                                                                    <td class="text-end"><span
                                                                            class="font-weight-bold">$43.19</span></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="ps-5"><i class="flag flag-ca"></i></td>
                                                                    <td>Canada</td>
                                                                    <td class="text-end"><span
                                                                            class="font-weight-bold">$56.19</span></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="ps-5"><i class="flag flag-ge"></i></td>
                                                                    <td>Germany</td>
                                                                    <td class="text-end"><span
                                                                            class="font-weight-bold">$49.00</span></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="w-1 text-center ps-5"><i
                                                                            class="flag flag-us "></i></td>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row text-center">
                                            <div class="col-md-12">
                                                <img src="../assets/images/photos/award.png" alt="img"
                                                    class="sales-img">
                                                <h2 class="mb-0 mt-4 fs-40 counter font-weight-bold">$1000k</h2>
                                                <span class="text-muted"><span class="text-green me-1"><i
                                                            class="fe fe-arrow-up ms-1"></i>0.82%</span> since last
                                                    year</span>
                                                <p class="mt-5 mb-2 text-muted fs-18">You have done 99.9% target sales
                                                    reached today. </p>
                                        ...
                                        <div class="scrollbar h-400" id="scrollbar">
                                            <div class="d-flex mb-5">
                                                <a href="javascript:void(0)" class="me-4">
                                                    <img class="w-8 h-8 rounded shadow"
                                                        src="../assets/images/orders/1.jpg" alt="media1">
                                                </a>
                                                <div class="mt-3">
                                            ...
                                            <div class="d-flex mb-5">
                                                <a href="javascript:void(0)" class="me-4">
                                                    <img class="w-8 h-8 rounded shadow"
                                                        src="../assets/images/orders/2.jpg" alt="media1">
                                                </a>
                                                <div class="mt-3">
                                            ...
                                            <div class="d-flex mb-5">
                                                <a href="javascript:void(0)" class="me-4">
                                                    <img class="w-8 h-8 rounded shadow"
                                                        src="../assets/images/orders/3.jpg" alt="media1">
                                                </a>
                                                <div class="mt-3">
                                            ...
                                            <div class="d-flex mb-5">
                                                <a href="javascript:void(0)" class="me-4">
                                                    <img class="w-8 h-8 rounded shadow"
                                                        src="../assets/images/orders/4.jpg" alt="media1">
                                                </a>
                                                <div class="mt-3">
                                            ...
                                            <div class="d-flex mb-5">
                                                <a href="javascript:void(0)" class="me-4">
                                                    <img class="w-8 h-8 rounded shadow"
                                                        src="../assets/images/orders/5.jpg" alt="media1">
                                                </a>
                                                <div class="mt-3">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td class="font-weight-bold"><img
                                                                    class="w-7 h-7 rounded shadow me-3"
                                                                    src="../assets/images/orders/7.jpg" alt="media1">
                                                                New Book</td>
                                                            <td>#12323423</td>
                                                            <td>11th July, 10am</td>
                                                            <td class="font-weight-bold">$13,206</td>
                                                            <td><span
                                                                    class="badge bg-primary rounded-pill">Completed</span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="font-weight-bold"><img
                                                                    class="w-7 h-7 rounded shadow me-3"
                                                                    src="../assets/images/orders/8.jpg" alt="media1">
                                                                New Bowl</td>
                                                            <td>#26762768</td>
                                                            <td>11th July, 10am</td>
                                                            <td class="font-weight-bold">$13,206</td>
                                                            <td><span
                                                                    class="badge bg-warning rounded-pill">Pending</span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="font-weight-bold"><img
                                                                    class="w-7 h-7 rounded shadow me-3"
                                                                    src="../assets/images/orders/9.jpg" alt="media1">
                                                                Modal Car</td>
                                                            <td>#76273277</td>
                                                            <td>11th July, 10am</td>
                                                            <td class="font-weight-bold">$13,206</td>
                                                        ...
                                                        <tr>
                                                            <td class="font-weight-bold"><img
                                                                    class="w-7 h-7 rounded shadow me-3"
                                                                    src="../assets/images/orders/10.jpg" alt="media1">
                                                                Headset</td>
                                                            <td>#67237267</td>
                                                            <td>11th July, 10am</td>
                                                            <td class="font-weight-bold">$13,206</td>
                                                            <td><span
                                                                    class="badge bg-danger rounded-pill">Declined</span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="font-weight-bold"><img
                                                                    class="w-7 h-7 rounded shadow me-3"
                                                                    src="../assets/images/orders/11.jpg" alt="media1">
                                                                New Headset</td>
                                                            <td>#561527167</td>
                                                            <td>11th July, 10am</td>
                                                            <td class="font-weight-bold">$13,206</td>
                                                        ...
                                                        <tr>
                                                            <td class="font-weight-bold"><img
                                                                    class="w-7 h-7 rounded shadow me-3"
                                                                    src="../assets/images/orders/12.jpg" alt="media1">
                                                                Watch</td>
                                                            <td>#12323423</td>
                                                            <td>11th July, 10am</td>
                                                            <td class="font-weight-bold">$13,206</td>
                                                        ...
                                                        <tr>
                                                            <td class="font-weight-bold"><img
                                                                    class="w-7 h-7 rounded shadow me-3"
                                                                    src="../assets/images/orders/13.jpg" alt="media1">
                                                                Branded Shoes</td>
                                                            <td>#26762768</td>
                                                            <td>11th July, 10am</td>
                                                            <td class="font-weight-bold">$13,206</td>
                                                        ...
                                                        <tr>
                                                            <td class="font-weight-bold"><img
                                                                    class="w-7 h-7 rounded shadow me-3"
                                                                    src="../assets/images/orders/14.jpg" alt="media1">
                                                                New Modal shoe</td>
                                                            <td>#12323423</td>
                                                            <td>11th July, 10am</td>
                                                            <td class="font-weight-bold">$13,206</td>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td class="d-flex">
                                                                ...
                                                                <div class="mt-2">
                                                                    <h6 class="mb-1 font-weight-semibold">John Wisely
                                                                    </h6>
                                                                    <small class="text-muted">1340 Gills Rd, VA,
                                                                        23139</small>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="d-flex">
                                                                ...
                                                                <div class="mt-2">
                                                                    <h6 class="mb-1 font-weight-semibold">Nicki Fanning
                                                                    </h6>
                                                                    <small class="text-muted">408 1st St, NC,
                                                                        28468</small>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="d-flex">
                                                                ...
                                                                <div class="mt-2">
                                                                    <h6 class="mb-1 font-weight-semibold">Lula Malone
                                                                    </h6>
                                                                    <small class="text-muted">104 Jefferson Ln, TN,
                                                                        37643</small>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="d-flex">
                                                                ...
                                                                <div class="mt-2">
                                                                    <h6 class="mb-1 font-weight-semibold">Rina Summa
                                                                    </h6>
                                                                    <small class="text-muted">49 Scott Dr, NY,
                                                                        10941</small>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="d-flex">
                                                                ...
                                                                <div class="mt-2">
                                                                    <h6 class="mb-1 font-weight-semibold">Yadira Acklin
                                                                    </h6>
                                                                    <small class="text-muted">507 E 22nd St S, IA,
                                                                        50208</small>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="d-flex">
                                                                ...
                                                                <div class="mt-2">
                                                                    <h6 class="mb-1 font-weight-semibold">Joanna Latta
                                                                    </h6>
                                                                    <small class="text-muted">511 N Walnut St, LA,
                                                                        71082</small>
                                                                </div>
                                                            </td>
                                                        </tr>
                                        ...
                                        <div class="card-options">
                                            <div class="btn-group mb-0">
                                                <button type="button" class="btn btn-white dropdown-toggle"
                                                    data-bs-toggle="dropdown" aria-expanded="false"><i
                                                        class="fe fe-plus"></i> Add New Order</button>
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="javascript:void(0)"><i
                                                            class="fa fa-plus me-2"></i>Add new Order</a>
                                                    <a class="dropdown-item" href="javascript:void(0)"><i
                                                            class="fa fa-eye me-2"></i>View all new tab</a>
                                                    <a class="dropdown-item" href="javascript:void(0)"><i
                                                            class="fa fa-edit me-2"></i>Edit Page</a>
                                                    <div class="dropdown-divider"></div>
                                                    <a class="dropdown-item" href="javascript:void(0)"><i
                                                            class="fa fa-cog me-2"></i> Settings</a>
                                                </div>
