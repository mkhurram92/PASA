                ...
                <div class="col-md-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-header  justify-content-between">
                            <h3 class="card-title">Subscription Plans Table</h3>
                            @can('subscription-plans-create')
                                <div class="text-right">
                                    <a class="modal-effect btn btn-primary btn-block" href="javascript:void(0)"
                                        id="createNewStates" data-bs-effect="effect-slide-in-right">Create Subscription
                                        Plans</a>
                                </div>
                            @endcan
                        </div>
...
@section('scripts')
    <script>
        var dt_master_elem = $("#subscription-plans-table"),
            dt_master = "";
        window.addEventListener("DOMContentLoaded", function() {
            ...
            const initDataTable = () => {
                if ($.fn.DataTable.isDataTable($('#subscription-plans-table'))) {
                    $('#subscription-plans-table').DataTable().destroy();
                }
                // user datatable
