<div
    ...
    <div class="mt-8 grid md:grid-cols-2 gap-x-2 gap-y-6 w-full">
        ...
        <div>
            ...
            <x-text-input type="text" id="card_number" class="block mt-1 w-full" name="card_number"
        ...
        <div>
            ...
            <x-text-input type="text" id="card_expiry" class="block mt-1 w-full" name="card_expiry"
        ...
        <div>
            ...
            <x-text-input type="text" id="card_cvc" class="block mt-1 w-full" name="card_cvc"
